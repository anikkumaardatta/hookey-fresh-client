...
const ContractUs = () => {
  return (
    <div>
      <div className='container my-8 mx-auto px-2 md:px-4 text-gray-700'>
          ...
          <div className='flex flex-wrap'>
            <form className='mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6'>
              <div className='mb-3 w-full'>
                <label className='block font-medium mb-[2px] text-secondary' htmlFor='exampleInput90'>
                  Name
                </label>
                <input
                  type='text'
              ...
              <button
                type='button'
                className='mb-6 inline-block w-full rounded bg-primary px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-secondary'>
                Send
              </button>
            </form>
                ...
                <div className='mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6'>
                  <div className='flex items-start'>
                    <div className='shrink-0'>
                      <div className='inline-block rounded-md bg-teal-400-100 p-4 text-secondary'>
                        <svg
